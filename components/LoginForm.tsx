  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      console.log("Login response data:", {
        ...responseData,
        session_token: responseData.session_token ? "exists" : "missing", // Don't log the actual token
      })

      // Ensure we have all the required user data
      ...
      console.log("Normalized user data:", {
        ...userData,
        session_token: userData.session_token ? "exists" : "missing", // Don't log the actual token
      })
